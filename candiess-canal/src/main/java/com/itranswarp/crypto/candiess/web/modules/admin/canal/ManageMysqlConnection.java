...
public class ManageMysqlConnection extends MysqlConnection implements ErosaConnection {

	private static final Logger logger = LoggerFactory.getLogger(ManageMysqlConnection.class);
	...
	private SinkToMq sinkToMq = new SinkToMq(charset);
	private long id;

	public ManageMysqlConnection() {
		this.sinkToMq = new SinkToMq(charset);
	}

	public ManageMysqlConnection(InetSocketAddress address, String username, String password) {
		this.sinkToMq = new SinkToMq(charset);
	...
	public ManageMysqlConnection(InetSocketAddress address, String username, String password, byte charsetNumber,
			String defaultSchema, long id) {
		this.sinkToMq = new SinkToMq(charset);
		sinkToMq.setId(id);
		authInfo = new AuthenticationInfo();
		authInfo.setAddress(address);
	...
	public ManageMysqlConnection fork() {
		ManageMysqlConnection connection = new ManageMysqlConnection();
