...
package com.itranswarp.crypto.candiess.generator.utils;
...
import com.itranswarp.crypto.candiess.generator.entity.ColumnEntity;
import com.itranswarp.crypto.candiess.generator.entity.TableEntity;
...
public class GenUtils {
		...
		for (String template : templates) {
			...
			try {
				...
				zip.putNextEntry(new ZipEntry(getFileName(template, tableEntity.getClassName(),
						config.getString("package"), config.getString("moduleName"), db)));
	...
	public static String getFileName(String template, String className, String packageName, String moduleName,
		...
		if (template.contains("Dao.xml.vm")) {
			return "main" + File.separator + "resources" + File.separator + "mapper" + File.separator + db
